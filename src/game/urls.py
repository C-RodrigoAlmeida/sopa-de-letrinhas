...
from src.game.views import WordCreateView, WordUpdateView, WordListView, WordDeleteView, WordDetailsView, JointCreateView, JointUpdateView, JointListView, JointDetailsView, JointDeleteView
